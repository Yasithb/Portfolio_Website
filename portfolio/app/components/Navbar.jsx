    ...
    <>
      ...
      >
        ...
        <div className='flex items-center gap-4 animate-slide-left'>
          ...
          <a
            href="#contact"
            className={`hidden lg:flex items-center gap-3 px-10 py-2.5 rounded-full ml-4 transition-all duration-500 
              hover:shadow-lg hover:shadow-blue-500/20 hover:-translate-y-1 relative overflow-hidden group ${
              isDark 
          ...
          >
            ...
            <Image 
              ...
              alt='' 
              className='w-3 relative transition-transform duration-300 group-hover:translate-x-1' 
            />
          </a>
        ...
        >
          ...
          <div className="mt-6 pt-6 border-t border-gray-700/30">
            <a
              href="#contact"
              className={`flex items-center justify-center gap-3 px-6 py-2.5 rounded-full transition-all duration-500 
